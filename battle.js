...
(function(){
  var $SET_TIMEOUT, $BULLET_SPEED, $HP, $ROBOT_RADIUS, $SEQUENTIAL_EVENTS, $PARALLEL_EVENTS, $CANVAS_DEBUG, $DIV_DEBUG, AssetsLoader, degreesToRadians, radiansToDegrees, euclid_distance, in_rect, Robot, Battle;
  $SET_TIMEOUT = 10;
  $BULLET_SPEED = 3;
  $HP = 20;
  $ROBOT_RADIUS = 10;
  ...
  Battle = (function(){
    ...
    prototype._draw = function(){
      ...
      for (id in ref$ = constructor.robots) {
        ...
        textX = 40;
        textY = 30;
        if (this.width - robot.x < 30) {
          textX = -textX;
        }
        if (this.height - robot.y < 30) {
          textY = -textY;
        }
        text = robot.hp + "/" + $HP;
        if ($CANVAS_DEBUG) {
