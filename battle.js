...
(function(){
  var $SET_TIMEOUT, $SEQUENTIAL_EVENTS, $PARALLEL_EVENTS, AssetsLoader, degrees_to_radians, euclid_distance, in_rect, Robot, Battle;
  $SET_TIMEOUT = 20;
  ...
  Robot = (function(){
    ...
    prototype.move = function(distance){
      ...
      if (in_rect(this.x, this.y, 0, 0, constructor.battlefieldWidth, constructor.battlefieldHeight)) {
  ...
  Battle = (function(){
    ...
    prototype.send_all = function(msg_obj){
      ...
      for (i$ = 0, len$ = (ref$ = this.robots).length; i$ < len$; ++i$) {
        robot = ref$[i$];
